...
from ocgis.new_interface.mpi import MPI_RANK, MPI_COMM, variable_gather, MPI_SIZE
...
class TestGridXY(AbstractTestNewInterface):
    ...
    def test_grid_get_intersects_barbed_geometry(self):
    ...
    def test_get_intersects_parallel(self):
        ...
        with self.assertRaises(EmptySubsetError):
            grid.get_intersects(bounds_sequence)
        ...
        for k in self.iter_product_keywords(keywords):
            ...
            grid_sub, slc = grid.get_intersects(bounds_sequence, keep_touches=k.keep_touches, use_bounds=k.use_bounds,
                                                return_slice=True)
    ...
    def test_get_intersects_small(self):
        ...
        for a in as_bounds_tuple:
            ...
            if a:
                ...
                the_subset = subset
            sub, slc = grid.get_intersects(the_subset, return_slice=True)
        ...
        for with_bounds in [False, True]:
            ...
            if with_bounds:
                ...
                if MPI_SIZE == 2:
                    ...
                    self.assertEqual(grid_bounds_global, [(0, 46), (0, 100)])
